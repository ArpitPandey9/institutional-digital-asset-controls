...
class ReasonCode(str, Enum):
    ...
    NO_PRIOR_INSTRUCTION_CONSUMPTION = "NO_PRIOR_INSTRUCTION_CONSUMPTION"
    NO_PRIOR_TRANSFER_CONSUMPTION = "NO_PRIOR_TRANSFER_CONSUMPTION"
    INSTRUCTION_ALREADY_CONSUMED = "INSTRUCTION_ALREADY_CONSUMED"
    TRANSFER_ALREADY_CONSUMED = "TRANSFER_ALREADY_CONSUMED"
    CANONICAL_ASSET_MATCH = "CANONICAL_ASSET_MATCH"
    CANONICAL_ASSET_MISMATCH = "CANONICAL_ASSET_MISMATCH"
...
class ControlName(str, Enum):
    ...
    AMOUNT = "AMOUNT"
    FINALITY = "FINALITY"
    INSTRUCTION_UNIQUENESS = "INSTRUCTION_UNIQUENESS"
    TRANSFER_UNIQUENESS = "TRANSFER_UNIQUENESS"
